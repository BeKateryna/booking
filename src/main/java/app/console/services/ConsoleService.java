...
public class ConsoleService {
    ...
    public static int readFlightId(String prompt) {
        ...
        while (true) {
            ...
            if (enteredIdIsCorrect) break;
                ...
                System.out.println("Не корректный номер рейса. ");
                System.out.println("Пожалуйста, введите правильный номер рейса. Формат: 1.");
            }
        }
    ...
    public static String destination(String prompt) {
        ...
        while (true) {
            ...
            if (enteredIdIsCorrect) break;
                ...
                System.out.println("Не верно введено место назначения. Образец: Kyiv");
                System.out.println("Пожалуйста, введите дату согласно образцу");
            }
        }
        return input;
    }
    public static String date(String prompt) {
        ...
        while (true) {
            ...
            if (enteredIdIsCorrect) break;
                ...
                System.out.println("Вы ввели не верную дату. Формат: 2022-03-15");
                System.out.println("Пожалуйста, введите дату в нужном формате");
            }
        }
        return input;
    }
    ...
    public static String readString(String prompt) {
        ...
        while (true) {
            ...
            if (matcher.find()) {
                System.out.println("Не корректный формат данных. В данной строке не " +
                        "должно быть цифр.");
                continue;
            }
